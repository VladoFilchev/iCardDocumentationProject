<template>
  <div class="carts-page">
    <header class="carts-topbar">
      <div class="carts-topbar-left">
  ...
  ← Back to landing
        ...
        <div>
          ...
          <div class="top-title">Carts Explorer</div>
        </div>
      </div>

      <div class="top-tags">
        <span class="top-tag">Plugin documentation</span>
        <span class="top-tag">iCard blue theme</span>
      </div>
    </header>

    <div class="carts-layout">
      <aside class="carts-sidebar">
        <div class="sidebar-brand">
          <img src="/logo.png" alt="iCard logo" class="sidebar-logo" />
          <div>
            <div class="sidebar-brand-subtitle">Carts documentation</div>
          </div>
        </div>
        ...
        <div class="sidebar-search-wrap">
          <input
            ...
            placeholder="Search guides or platforms"
          />
        </div>
      ...
      <main class="carts-main">
        <div class="content-hero">
          <div class="content-topline">
            <span class="hero-chip">Carts</span>
      ...
      <aside class="carts-codebar">
        <div class="codebar-sticky">
          <div class="code-panel">
            <div class="code-panel-header">
              <div class="code-label">Request / flow</div>
...
import "./CartsExplorer.css";
import { cartsMenu, cartsContent } from "../data/cartsData";
...
const filteredMenu = computed(() => {
  if (!query.value.trim()) return cartsMenu;
...
const allItems = computed(() => cartsMenu.flatMap((group) => group.items));

const activeMeta = computed(() => {
  return (
    allItems.value.find((item) => item.id === activeId.value) ||
    allItems.value[0]
  );
});

const active = computed(() => cartsContent[activeId.value]);
